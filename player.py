...
class Player:
    ...
    def set_side_stones_positions(self):
        ...
        bug_position = ((frame_x_size * 21) // 40, 5*y_distance + 4*hexa_size * sqrt_3)
        ...
        if self.color == "black":
            ...
            bug_position = (bug_position[0] + right_frame_translate[0], bug_position[1] + right_frame_translate[1])
